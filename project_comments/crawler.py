...
def crawl_comments():
    ...
    # 스팀 이벤트&공지에 대한 페이지
    game_id = 1217390 # 스팀 페이지의 고유 게임 id. 예시로 스팀 공지 링크 보면 https://steamcommunity.com/app/367520/eventcomments/ 이렇게 되어있는데 3번째꺼. 다른 게임 가져올거면 game_id만 바꾸면 됨
    ...
    #Chapter4 db 저장 start
        # 공지와 댓글 db에 저장
        conn = sqlite3.connect("steam_comments.db")
        cur = conn.cursor()
